...
int main() {
    ...
    // ORDERED MAP HAI YE -> map<int,string> table;
    // ORDERED MAP ME SORTED AYE GA DATA
    // UNORDERED MAP HAI YE -> unordered_map<int,string> table;
    // UN_ORDERED MAP ME UNSORTED AYE GA DATA
